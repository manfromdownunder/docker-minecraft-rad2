...
RUN apt-get update && \
    ...
    apt-get install -y libxcomposite1 libatk1.0-0 libnss3 libxss1 libasound2 libpangocairo-1.0-0 libcups2 libxrandr2 libgbm1 libatk-bridge2.0-0 libxkbcommon0 && \
    apt-get clean && \
    rm -rf /var/lib/apt/lists/*
