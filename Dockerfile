...
RUN apt-get update && \
    apt-get install -y --no-install-recommends mcrcon cron screen software-properties-common wget git curl unzip tar nano logrotate gnupg2 apt-transport-https && \
